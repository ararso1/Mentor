...
?>
  ...
  <section id="hero" class="d-flex justify-content-center align-items-center">
    <div class="container position-relative" data-aos="zoom-in" data-aos-delay="100">
      ...
      <h2>We are thankful for those who are benefited from this website </h2>
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content">
            <h3>Popular Topics in this Website(by English)</h3>
            <p class="fst-italic">
              The following is the most popular topoics in this site. Click on the title and you can get the details.
            </p>
            <ul>
 ...
 -->         </ul>
            <p>
             Then we are very happy to provide two language based education site by English and Afaan Oromoo.  
            </p>

          </div>
          <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content">
            <h3>Mataduree Weebsaayitii kana kessatti baay'ee Hawwatoo ta'an(Afaan oromootin)</h3>
            <p class="fst-italic">
              Matadureen armaan gadii kun kan baay'ee hawwato ta'aniifi beekumsa gudda irra argatanidha. Click gochun dabalatan ilaala.
            </p>
            <ul>
